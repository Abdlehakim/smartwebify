...
const LoadingDots: React.FC<LoadingDotsProps> = ({
  ...
  if (isSuccess && successMessage) {
    return (
      <div className="w-full h-full  bg-opacity-50 flex justify-center items-center rounded-xl">
  ...
  return (
    <div className="w-full h-full  bg-opacity-80 flex flex-col justify-center items-center rounded-xl">  
